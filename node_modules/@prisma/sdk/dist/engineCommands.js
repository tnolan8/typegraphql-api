...
path_1.default.join(__dirname, '../query-engine-rhel-openssl-1.0.x');
path_1.default.join(__dirname, '../introspection-engine-rhel-openssl-1.0.x');
function getDMMF({ datamodel, cwd = process.cwd(), prismaPath, datamodelPath, retry = 4, }) {
    return __awaiter(this, void 0, void 0, function* () {
        debug(`getDMMF, override prismaPath = ${prismaPath}`);
        prismaPath = prismaPath || (yield resolveBinary_1.resolveBinary('query-engine'));
        let result;
        try {
            ...
            result = yield execa_1.default(prismaPath, ['--enable-raw-queries', 'cli', 'dmmf'], options);
            if (!datamodelPath) {
            ...
            if (e.message.includes('in JSON at position')) {
                throw new Error(`Problem while parsing the query engine response at ${prismaPath}. ${result.stdout}\n${e.stack}`);
            }
            throw new Error(e);
        }
    });
...
function getConfig({ datamodel, cwd = process.cwd(), prismaPath, datamodelPath, }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const result = yield execa_1.default(prismaPath, ['cli', 'get-config'], {
                cwd,
