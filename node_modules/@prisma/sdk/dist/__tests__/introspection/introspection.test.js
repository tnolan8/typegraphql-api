...
test('introspection basic', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield engine.introspect(schema);
    expect(result).toMatchInlineSnapshot(`
      ...
      `);
    const metadata = yield engine.getDatabaseMetadata(schema);
    expect(metadata).toMatchInlineSnapshot(`
      ...
      `);
    const databases = yield engine.listDatabases(schema);
    expect(databases).toMatchInlineSnapshot(`
      ...
      `);
    const description = yield engine.getDatabaseDescription(schema);
