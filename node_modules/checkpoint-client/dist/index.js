...
var default_1 = envPaths;
envPaths_1.default = default_1;
...
// configure the configuration in a consistent way across processes
async function configure$1(state) {
  return Config$1.new(state, defaultSchema$1)
}
...
class Config$1 {
  static async new(state, defaultSchema) {
    ...
    return new Config$1(state, defaultSchema)
  }

  // create the configuration synchronously
  static sync(state, schema = defaultSchema$1) {
    makeDir_1.sync(path.dirname(state.cache_file));
    return new Config$1(state, schema)
  }
...
// TODO: Remove this for the next major release
var default_1$1 = pathKey;
pathKey_1.default = default_1$1;

const pathKey$1 = pathKey_1();
...
async function check(input) {
  ...
  const config = await configure$1(state);
